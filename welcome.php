...
if (!$conn) {
  ...
  $questions = array(
  array("<div class='question'>In which Italian city can you find the Colosseum?</div>", "Rome", array("Milan", "Rome", "Naples", "Venice")),
  array("<div class='question'>Who proposed the theory of relativity?</div>", "Albert Einstein", array("Alexander Graham Bell", "Albert Einstein", "Charles Darwin", "John Dalton")),
  array("<div class='question'>Who is the author of the Harry Potter series?</div>", "J.K Rowling", array("J.R.R Tolkien", "Stefanie Meyer", "Suzanne Collins", "J.K Rowling")),
  array("<div class='question'>Which is the fastest animal on land?</div>", "Cheetah", array("Horse", "Cheetah", "Giraffe", "Lion"))
);

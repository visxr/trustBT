...
require("connection.php");
  ...
  $questions = array(
    array("Which is the easiest way to tell the age of many trees?", "To count the rings on the trunk", array("To measure the width of the tree", "To count the rings on the trunk", "To count the number of leaves", "To measure the height of the tree")),
    array("What is the first element in the periodic table of elements?", "Hydrogen", array("Oxygen", "Radon", "Nitrogen", "Hydrogen")),
    array("Which animal is known as the “Ship of the desert?", "Camel", array("Lizard", "Camel", "Fox", "Scorpion")),
...
nav li a:hover {
  ...
  <ul>
    ...
    <h2 style="text-align: center; color: orange">Quizzle - Day 4</h2>
